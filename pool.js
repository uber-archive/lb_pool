...
function Pool(http, endpoints, options) {
    ...
    options.endpointLengthValidation = options.endpointLengthValidation !== undefined ? options.endpointLengthValidation : true;
    ...
    if (options.endpointLengthValidation && this.endpoints.length === 0) {
